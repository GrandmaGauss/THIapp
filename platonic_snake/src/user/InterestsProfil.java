...
@WebServlet("/InterestsProfil")
public class InterestsProfil extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("users", users);
         ...
         //Weiterleiten an JSP
        final RequestDispatcher disp = request.getRequestDispatcher("jsp/Interests/User.jsp");
